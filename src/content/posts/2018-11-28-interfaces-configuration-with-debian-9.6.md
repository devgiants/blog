---
slug: interfaces-configuration-with-debian-9.6
locale: en
...
## Context
As I stated [in my previous post](/blog/2018/11/27/netplan-handling-network/), I changed from ubuntu Server 18.10 to Debian 9.6 for the system I'm building (a router/firewall and application server for home automation). Below ismytraces for interface configuration.
 
## Renaming
As I also stated [in my previous post](/blog/2018/11/27/netplan-handling-network/), I need renaming for 2 reasons :
